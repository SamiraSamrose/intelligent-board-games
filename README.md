...
Advanced board game platform powered by Google Gemini AI with Genie3 VR integration, implementing research from Google and Google DeepMind's primary research works.
...
- **Notebooks Complementing The Research Papers**:
    ...
    [Notebook containing extended research for Societies of Thought Paper](https://github.com/SamiraSamrose/intelligent-board-games/blob/main/notebooks/Societies_of_Thought/Societies_of_Thought.ipynb)

    [Notebook containing extended research for Mask or to Mirror Paper](https://github.com/SamiraSamrose/intelligent-board-games/blob/main/notebooks/Mask_or_to_Mirror/Mask_or_to_Mirror.ipynb)
- **Originally Conducted And Published by Google Researchers (Research Papaer 1)**: "Reasoning Models Generate Societies of Thought" (2025) by Junsol Kim, Shiyang Lai, Nino Scherrer, Blaise Agüera y Arcas, James Evans [Read The Research Paper](https://arxiv.org/abs/2601.10825)
- **Originally Disseminated via Google DeepMind (Research Paper 2)**: "To Mask or to Mirror: Human-AI Alignment in Collective Reasoning" (2025) by Crystal Qian, Aaron Parisi, Clémentine Bouleau, Vivian Tsai, Maël Lebreton, Lucas Dixon [Read The Research Paper](https://deepmind.google/research/publications/180362/)
