...
- **Originally Conducted And Published by Google Researchers (Research Papaer 1)**: "Reasoning Models Generate Societies of Thought" (2025) by Junsol Kim, Shiyang Lai, Nino Scherrer, Blaise Agüera y Arcas, James Evans Research Paper [Read the paper](https://arxiv.org/abs/2601.10825)
- **Originally Disseminated via Google DeepMind (Research Paper 2)**: "To Mask or to Mirror: Human-AI Alignment in Collective Reasoning" (2025) by Crystal Qian, Aaron Parisi, Clémentine Bouleau, Vivian Tsai, Maël Lebreton, Lucas Dixon Research Paper [Read the paper](https://deepmind.google/research/publications/180362/)
